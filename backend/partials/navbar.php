...
// pastikan sudah ada $_SESSION['nama'] saat login
$namaUser = isset($_SESSION['nama']) ? $_SESSION['nama'] : 'Guest';
    ...
    <nav class="navbar flex-nowrap p-0">
         <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="../../template-admin/public/img/logoremove-buku.png" alt="Graindashboard">
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="#">
                <img class="side-nav-show-on-closed" src="../../template-admin/public/img/logoremove-buku.png" alt="Graindashboard" style="height: 75px; width: auto; margin-right: 10px;">
                <img class="side-nav-hide-on-closed" src="../../template-admin/public/img/buku-logo-text.png" alt="Graindashboard" style="height: 120px; width: auto; margin-right: 10px;">
            </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown mx-3 dropdown ml-2">
                    <a id="profileMenuInvoker" class="header-complex-invoker" href="#" aria-controls="profileMenu" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-target="#profileMenu" data-unfold-type="css-animation" data-unfold-duration="300" data-unfold-animation-in="fadeIn" data-unfold-animation-out="fadeOut">
                       ...
                       <span class="mr-md-2 avatar-placeholder"><?= $initials ?></span>
                        <span class="d-none d-md-block"><?= $namaUser ?></span>
